...
namespace AntiCoreCheat.SDK.Memory
{
    ...
    class CylMemLite
    {
        ...
        {
            NativeMethods.VirtualFreeEx(ProcessHandle, (IntPtr)address, (IntPtr)0, FreeType.Release);
        }
        ...
        internal static void WriteByte(int address, byte value)
        {
            ...
            uint nBytesRead = 0;
            NativeMethods.WriteProcessMemory(ProcessHandle, (IntPtr)address, buffer, (IntPtr)1, ref nBytesRead);
        }
        #endregion
        ...
        internal static byte[] ReadBytes(int address, int size)
        {
            ...
            uint nBytesRead = 0;
            NativeMethods.ReadProcessMemory(ProcessHandle, (IntPtr)address, buffer, (uint)size, ref nBytesRead);
            return buffer;
        }
        ...
        public static void CWrite<T>(IntPtr Address, object Value)
        {
        ...
        public static void CWrite<T>(IntPtr Address, char[] Value)
        {
            uint m_iBytesWritten = 0;
        ...
        //    NativeMethods.ReadProcessMemory(ProcessHandle, Address, buffer, (uint)buffer.Length, ref m_iBytesWritten);
    ...
    class SigScan
    {
        ...
        public bool SelectModule(IntPtr hModule, int SizeOfImage)
        {
            ...
            return CylMemLite.NativeMethods.ReadProcessMemory(g_hProcess, hModule, g_arrModuleBuffer, (uint)SizeOfImage, ref a);
        }
        ...
        {
            IntPtr hProcess = CylMemLite.hProcess.Handle;
            ProcessModule SelectedModule = null;
            foreach (ProcessModule module in CylMemLite.hProcess.Modules)
            {
