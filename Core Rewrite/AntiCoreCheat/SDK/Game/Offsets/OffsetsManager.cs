    ...
    class OffsetsManager
    {
        ...
        private static void GetSignatures()
        {
            try
            {
                ...
                Signatures.set_abs_angles = SigScan.ScanPatterna(Modules.ClientDLLName, "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8").ToInt32() - Modules.ClientDLLAdress.ToInt32();
                Signatures.set_abs_origin = SigScan.ScanPatterna(Modules.ClientDLLName, "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8").ToInt32() - Modules.ClientDLLAdress.ToInt32();
                Signatures.is_c4_owner = SigScan.ScanPatterna(Modules.ClientDLLName, "56 8B F1 85 F6 74 31").ToInt32() - Modules.ClientDLLAdress.ToInt32();
                Signatures.force_update_spectator_glow = SigScan.ScanPatterna(Modules.ClientDLLName, "74 07 8B CB E8 ? ? ? ? 83 C7 10").ToInt32() - Modules.ClientDLLAdress.ToInt32();
                ...
                Signatures.find_hud_element = SigScan.ScanPatterna(Modules.ClientDLLName, "8B 3D ? ? ? ? 85 FF 0F 84 ? ? ? ? 81 C7").ToInt32() - Modules.ClientDLLAdress.ToInt32();
                sw.Stop();
                Application.DoEvents();
